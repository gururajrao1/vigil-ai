...
const MODES = [
  ...
  { id: 'semantic_scholar', label: 'Semantic Scholar',     note: 'Academic Graph paper abstracts' },
  { id: 'cochrane_central', label: 'Cochrane CENTRAL',     note: 'Trial-register abstracts · SRC:cctr' },
