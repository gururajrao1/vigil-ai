...
REGISTRY = [
    ...
    {"id": "faers_bulk", "name": "FDA FAERS quarterly bulk (ASCII subset)", "region": "US",
     "type": "connector", "modality": "spontaneous", "product": "drug",
     "endpoint": "/api/ingest/faers-bulk (+ offline fixtures)", "key_required": False,
     "status": "live",
     "note": "Keyless bulk slice / fixtures for polypharmacy DDI mining"},
    {"id": "vaers", "name": "CDC VAERS (vaccine adverse events)", "region": "US",
     "type": "connector", "modality": "spontaneous", "product": "vaccine",
     "endpoint": "/api/ingest/vaers (+ offline fixtures)", "key_required": False,
     "status": "live",
     "note": "Degrades to bundled fixtures when CDC endpoints are unreachable"},
    ...
    {"id": "pubmed", "name": "PubMed / NCBI E-utilities (literature abstracts)", "region": "Global",
     "type": "connector", "modality": "literature", "product": "both",
     "endpoint": "eutils esearch/efetch", "key_required": False, "status": "live"},
    {"id": "europe_pmc", "name": "Europe PMC (EMBL-EBI literature)", "region": "Global",
     "type": "connector", "modality": "literature", "product": "both",
     "endpoint": "europepmc.org/webservices/rest/search", "key_required": False, "status": "live"},
    {"id": "semantic_scholar", "name": "Semantic Scholar Academic Graph", "region": "Global",
     "type": "connector", "modality": "literature", "product": "both",
     "endpoint": "api.semanticscholar.org/graph/v1/paper/search", "key_required": False, "status": "live"},
    {"id": "cochrane_central", "name": "Cochrane CENTRAL (trial abstracts)", "region": "Global",
     "type": "connector", "modality": "literature", "product": "both",
     "endpoint": "Europe PMC SRC:cctr + offline fixtures", "key_required": False, "status": "live"},
