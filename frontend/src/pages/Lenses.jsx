...
export default function Lenses() {
  return (
    <HubShell
      ...
      subtitle="Predictive intel, Omni-Search, MCN, ontology, Remine, risk populations, DDI, pregnancy, SMQ, class effects, vaccine AESI, geo, and vs FAERS."
      tabDefs={TABS}
      defaultTab="intel"
    >
      {(tab) => {
        ...
        if (tab === 'mcn') return <MCN embedded />;
